...
export default function Projects() {
  ...
  const defaultProjects = [
    { id: '1', title: "Aramco Facility Pump Expansion", category: "Firefighting Systems", image: "/images/firefighting_systems_thumbnail_1779179053671.png", description: "Design and deployment of critical infrastructure.", duration: "12 Months", client: "Saudi Aramco" },
    { id: '2', title: "Riyadh Metro HVAC Phase 2", category: "HVAC & Cooling", image: "/images/hvac_cooling_thumbnail_1779179069525.png", description: "Tunnel ventilation and station cooling systems installation.", duration: "18 Months", client: "ADA" },
    { id: '3', title: "NEOM Grid Power Backup", category: "Power Generators", image: "/images/generators_power_thumbnail_1779179086020.png", description: "Installation of 50MW backup diesel generators array.", duration: "8 Months", client: "NEOM" }
  ];
